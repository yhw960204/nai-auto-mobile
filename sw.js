 ...
 */
const CACHE = "nai-mobile-e052e26c5e97";
const PRECACHE = ["./","assets/index-CJIGu3zo.js","assets/index-D07Yv27V.css","icons/apple-touch-icon.png","icons/favicon-64.png","icons/icon-192.png","icons/icon-512.png","icons/icon-maskable-512.png","manifest.webmanifest","tags.csv"];
